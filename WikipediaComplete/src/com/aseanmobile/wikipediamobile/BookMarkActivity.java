...
public class BookMarkActivity extends Activity implements OnItemClickListener , OnClickListener 
...
//        set on listener for long click
        bookMarkListView.setOnItemLongClickListener(this);
...
//    call when clicked
    private void showopen( final WikiData clickedData){
    	CustomeWebViewActivity.book_mark_url_to_open = new String ( clickedData.getUrl ( ) ) ;
        Utils.getGTRACKER ( getApplicationContext ( ) ).trackBookMarkEvent ( Constant.GoogleAnalytics.EVENT_BOOK_MARK_OPEN );
        finish ( ) ;
    }
